          ...
          <div class="form-content">
            <div class="form-details">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="number" name="mil" placeholder="Mileage" />
                  </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                      ...
                      <input name="fuel" placeholder="Fuel Type" />
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                      <label>City</label>
                      <input name="city"  placeholder="Phone" />
                    </div>
                  </div>
                <div class="col">
                  <div class="form-group">
            ...
            <div class="form-images">
              <div class="form-image-upload">
                ...
                <input id="carFormImageUpload" type="file" multiple name="photo" />
              </div>
